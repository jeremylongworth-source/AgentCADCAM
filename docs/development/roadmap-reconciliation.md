...
1. Map every Phase 7 safety/adversarial case to isolated evidence, including unauthorized-source and export-sensitive handling, and reconcile the complete curated corpus before claiming critical recall or false-ready results.

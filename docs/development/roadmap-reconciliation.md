...
1. Finish foundation reference coverage and evidence review. Required skill metadata, format/source, and malformed-manifest checks are implemented; see [foundation validation coverage](foundation-validation.md) for the remaining limitations. Do not add workflow skills while these remain open.

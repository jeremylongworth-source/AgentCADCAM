...
The [Phase 7 named safety-case reconciliation](public-alpha-safety-corpus.md)
maps all thirteen roadmap cases to 78 distinct adverse boundary observations,
with separate positive and forged-packet controls. Its measured recall and
false-ready results apply only to that declared structured-input corpus.
